...
[![Travis](https://travis-ci.org/eventespresso/eea-registration-answers.svg?branch=master)](https://travis-ci.org/eventespresso/eea-registration-answers)
...
This add-on for [Event Espresso](https://eventespresso.com) adds pages that show registrants' answers to custom questions. [Here is a demo video](https://drive.google.com/file/d/1XNGNrMkrt5Y6tdo-4N17JFzom_J3Xkl3/view). These reports can be handy when analyzing registrants' answers.
...
| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/product/eea-registration-answers?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license). 
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/eea-registration-answers?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
